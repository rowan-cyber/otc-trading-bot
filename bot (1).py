...
async def signal_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await handle_query(update, context, f"Give me a signal for {pair} OTC right now on M1 timeframe")
    ...
    try:
        ...
        user_histories[user_id].append({
            ...
            "content": [
                ...
                {
                    "type": "text",
                    "text": caption + " Give me a clear UP or DOWN signal with expiry and reasoning."
                }
            ]
        })
